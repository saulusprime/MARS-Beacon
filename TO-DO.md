...
Sezione conclusa PER INTERO il 2026-08-04 (v1.35.0–v1.37.0 / GUI
v2.14.0–v2.16.0 — vedi AS-IS): i nove widget del concept board più
tutte le idee rimandate — profondità di crawl, mappa a bolle
competitiva, form eventi e grafo force-directed dell'architettura
(layout Fruchterman-Reingold deterministico calcolato in Python,
così il referto HTML resta senza JavaScript).
